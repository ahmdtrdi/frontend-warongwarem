                                        ...
                                        {dummyData.map((item) => (
                                            <tr key={item.id}>
                                                ...
                                                <td>
                                                    ...
                                                    >
                                                        <option classname="requestedsts" value="Requested">Requested</option>
                                                        <option classname="reservedsts" value="Reserved">Reserved</option>
                                                        <option classname="rejectedsts" value="Rejected">Rejected</option>
